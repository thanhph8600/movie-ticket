...
<!-- <div class="noise"></div>
<div class="overlay flex justify-center"></div>
<div class="terminal text-4xl flex flex-col gap-4 items-center justify-center m-auto">
    <h1 class="text-9xl">Error <span class="errorcode ">404</span></h1>
    <p class="output">Bạn chưa đăng nhập, hãy đăng nhập để tiếp tục</p>
    <p class="output">Bạn hãy bấm vào đây <a class=" text-white" href="../trang_chinh/index.php">để quay lại trang chủ</a>.</p>
...
<div class="h-screen w-screen bg-gray-100 flex items-center">
	<div class="container flex flex-col md:flex-row items-center justify-center px-5 text-gray-700">
          ...
          <a href="../index.php" class="px-4 inline py-2 text-sm font-medium leading-5 shadow text-white transition-colors duration-150 border border-transparent rounded-lg focus:outline-none focus:shadow-outline-blue bg-blue-600 active:bg-blue-600 hover:bg-blue-700">back to homepage</a>
    </div>
      <div class="max-w-lg">
