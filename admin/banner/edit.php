            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Thêm ảnh</h6>
                    </div>
                    <div class="pst-ab">
                        <a href="./?"><i class="fa fa-arrow-circle-o-left" aria-hidden="true"></i></a>
                    </div>
                </div>
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        <form action="./index.php?btn_update" enctype="multipart/form-data" method="post" style="display:flex;width:95%;margin:auto">
                            ...
                            <input type="hidden" name="name_banner" value="<?=$banner['name']?>">
                            <input type="hidden" name="thumb_old" value="<?=$banner['thumb']?>">
                            ...
                            <div class="img-product">
                                <img style="display: block;" src="<?=$URL.$banner['thumb']?>" alt="" id="img-preview">
                            </div>
