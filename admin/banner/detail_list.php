                    ...
                    <div class="table-responsive p-0">
                        <div class="d-flex justify-content-between col-11 m-auto">
                            ...
                            <form action="./index.php?btn_add" method="post">
                                <input type="hidden" name="name_banner" value="<?=$name_banner?>">
                                <input name="next" type="submit" value="Thêm ảnh" class="input_Addproduct">
                            </form>
                        </div>
                        <table class="table align-items-center mb-0" style="width:99%;margin:auto">
                            <thead>
                                <tr>
                                    <th class="text-secondary opacity-7">Hình ảnh</th>
                                    ...
                                    <tr>
                                        <td class="">
                                            <div class="d-flex px-2 py-1 ">
                                                <div>
                                                    <img class="w-full col-12" src="<?=$URL. $thumb ?>" class="avatar avatar-xxl me-3 border-radius-lg" alt="user2">
                                                </div>
                                            </div>
                                        </td>

                                        <td>
                                            <p class="text-xl font-weight-bold mb-0 ms-4"><?= format_date($created_date) ?>
                                            </p>
                                        </td>

                                        <td class="align-middle">
                                            <form action="./index.php?btn_edit" method="post">
                                                <input type="hidden" name="name_banner" value="<?=$name?>">
                                        ...
                                        <td class="align-middle">
                                            <form action="./index.php?btn_delete" method="post" onsubmit="return deleteproduct()">
                                                ...
                                                <input type="hidden" name="name_banner" value="<?=$name?>">
                                                <input type="hidden" name="thumb_old" value="<?= $thumb ?>">
                                                <input type="hidden" name="id_banner" value="<?= $id ?>">
...
<script>
    ...
    $('.banner').addClass('bg-gradient-primary')
</script>
<!-- Github buttons -->
