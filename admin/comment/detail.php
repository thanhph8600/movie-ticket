                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        ...
                        <table class="table align-items-center mb-0" style="width:99%;margin:auto">
                            <thead>
                                <tr>
                                    <th class="text-secondary opacity-7">Tên khách hàng</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <td>
                                            <p class="text-xl font-weight-bold mb-0 ms-4"><?= $content ?>
                                            </p>
                                        </td>
                                        <td>
                                            <p class="text-xl font-weight-bold mb-0 ms-4">
                                                <?php
                                                for ($i = 0; $i < $vote; $i++) {
                                        ...
                                        <td>
                                            <p class="text-xl font-weight-bold mb-0 ms-4"><?= format_date($date_) ?>
                                            </p>
                                        </td>
                                        <td class="align-middle">
                                            <form action="./index.php?btn_delete" class="spagination" method="post" onsubmit="return deleteproduct()">
                                                <i class="fa fa-trash delete cursor-pointer" aria-hidden="true"></i>
                                                <input type="hidden" name="id_comment" class="id_comment" value="<?= $id ?>">
...
<script>
    ...
    $(document).on('click','.delete',function(){
        window.location.replace('../comment/index.php?btn_delete&id_comment=' + $('.id_comment').val())
