            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Cập nhật nước uống</h6>
                    </div>
                    <div class="pst-ab">
                    ...
                    <div class="table-responsive p-0">
                        <form action="./index.php?btn_update" enctype="multipart/form-data" method="post" style="display:flex;width:95%;margin:auto">
                            ...
                            <div class="img-product">
                                <img style="display: block;" src="<?=$UPLOAD_BEVERAGES_URL . $item['thumb']?>" alt="" id="img-preview">
                            </div>
                            <input type="hidden" name="id_beverages" value="<?=$item['id']?>">
