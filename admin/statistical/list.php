                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        ...
                        <table class="table align-items-center mb-0" style="width:99%;margin:auto">
                            <thead>
                                <tr>
                                    <th class="text-secondary opacity-7">Tên </th>
                                    <th class="text-secondary opacity-7">Tổng vé  </th>
                                    <th class="text-secondary opacity-7">Tổng tiền  </th>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="name">Top 5 phim được mua nhiều nhất</h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <p class="text-xl font-weight-bold mb-0 ms-4"><?= $sum_quantity_ticket ?> vé
                                            </p>
                                        </td>
                                        <td>
                                            <p class="text-xl font-weight-bold mb-0 ms-4"><?= currency_format($sum_price_ticket) ?>
                                            </p>
                                        </td>
                                        <td class="align-middle">
                                            <form action="./index.php?btn_detail" method="post">
                                                <input type="hidden" name="so_ve_ban_ra" value="1">
                                                <i class="fa fa-area-chart edit" aria-hidden="true"></i>

                                                <input name="" type="submit" value="Chi tiết" class="text-xs edit">
