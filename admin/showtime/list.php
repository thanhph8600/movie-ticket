            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">danh sách lịch chiếu</h6>
                    </div>
                </div>
                    ...
                    <div class="table-responsive p-0">
                        <div class="d-flex justify-content-between col-11 m-auto">
                            ...
                            <form action="./index.php?btn_add" method="post">
                                <input name="next" type="submit" value="Thêm phòng" class="input_Addproduct">
                            </form>
                        </div>
                        <table class="table align-items-center mb-0" style="width:99%;margin:auto">
                            <thead>
                                <tr>
                                    <th class="text-secondary opacity-7">Tên phim</th>
                                    <th class="text-secondary opacity-7">Số xuất chiêu</th>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="name"><?= $nameFilm ?></h6>
                                                </div>
                                            </div>
                                        </td>
                                        <td>
                                            <p class="text-xl font-weight-bold mb-0 ms-4"><?= $item['tong'] ?>
                                            </p>
                                        </td>
