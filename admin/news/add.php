            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Thêm tin tức</h6>
                    </div>
                    <div class="pst-ab">
                        ...
                        <form action="./index.php?btn_insert" enctype="multipart/form-data" method="post" style="display:flex;width:95%;margin:auto">
                            <div class="row pb-4">
                                <div class="col-12">
                                    ...
                                    <input class=" flex-auto focus:outline-none" type="text" name="title">
                                ...
                                <div class="col-12">
                                    ...
                                    <input class=" flex-auto focus:outline-none" type="text" name="content">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="detail_content" class="detail_content"></textarea>
                                    <script>
