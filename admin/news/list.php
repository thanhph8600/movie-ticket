                    ...
                    <div class="table-responsive p-0">
                        <div class="d-flex justify-content-between col-11 m-auto">
                            ...
                            <form action="./index.php?btn_add" method="post">
                                <input name="next" type="submit" value="Thêm " class="input_Addproduct">
                            </form>
                        </div>
                        <table class="table align-items-center mb-0" style="width:99%;margin:auto">
                            <thead>
                                <tr>
                                    <th class="text-secondary opacity-7">Tin tức</th>
                                    ...
                                    <tr>
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                <div>
                                                    <img src="../../uploaded/news/<?= $thumb ?>" class="avatar avatar-xxl me-3 border-radius-lg" alt="user2">
                                                </div>
