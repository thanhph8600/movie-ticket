            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Thêm film</h6>
                    </div>
                    <div class="pst-ab">
                        ...
                        <form action="./index.php?btn_insert" enctype="multipart/form-data" method="post" style="display:flex;width:95%;margin:auto">
                            <div class="row pb-4">
                                ...
                                <div class="col-4">
                                    ...
                                    <input name="directors" type="text" id="directors" value="">
                                    <?php
                            ...
                            <div class="row pb-4">
                                <div class="col-6">
                                    ...
                                    <input name="actor" type="text" id="actor" value="">
                                    <?php
                                ...
                                <div class="col-6">
                                    ...
                                    <input name="genre" type="text" id="genre" value="">
                                    <?php
                            ...
                            <div class="row pb-4">
                                <div class="col-4">
                                    ...
                                    <input class="date" name="premiere" type="date" id="" value="">
                                    <?php
                                ...
                                <div class="col-4">
                                    ...
                                    <input name="language" type="text" id="language" value="">
                                    <?php
                                ...
                                <div class="col-4">
                                    ...
                                    <input name="time" type="number" id="time" value="">
                                    <?php
                            ...
                            <div class="row pb-4">
                                <div class="col-6">
                                    ...
                                    <input name="rated" type="text" id="rated" value="">
                                    <?php
                                ...
                                <div class="col-6">
                                    ...
                                    <input name="trailer" type="text" id="trailer" value="">
                                    <?php
