            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">trả lời câu hỏi</h6>
                    </div>
                    <div class="pst-ab">
                        ...
                        <form action="./index.php?btn_insert" enctype="multipart/form-data" method="post" style="display:flex;width:95%;margin:auto" onsubmit="return checkForm()">
                            <div class="row pb-4">
                                <div class="col-12">
                                    ...
                                    <textarea name="" readonly id="" class="input" rows="3" >
                                        <?=$question['question']?>
                                    </textarea>
                                    <?php
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="answer" class="answer"><?=$question['answer']?></textarea>
                                    <script>
...
<script>
    ...
    function checkForm(){
        if($('.answer').val() == '' || $('.answer').val().length ==0)
            return false
    }
