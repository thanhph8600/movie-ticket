            ...
            <div class="card my-4">
                ...
                <div class="card-body px-0 pb-2">
                    <div class="table-responsive p-0">
                        ...
                        <table class="table align-items-center mb-0" style="width:100%;margin:auto">
                            <thead>
                                <tr>
                            ...
                            <tbody>
                                ...
                                foreach ($questions as $item) {
                                    extract($item);
                                    (empty($answer)) ?  $err = 'Chưa trả lời' : $err = 'Đã trả lời' ;
                                ?>
                                    <tr <?=empty($answer) ? 'style="background:#ECEEF1"' : ''?> >
                                        <td>
                                        ...
                                        <td>
                                            <p class="text-xl font-weight-bold mb-0 ms-4"><?= $email ?>
                                            </p>
                                        </td>
                                        <td>
                                            <p class="text-xl font-weight-bold mb-0 ms-4"><?= $err ?>
                                            </p>
                                        </td>
                                        ...
                                        <td class="align-middle">
                                            <form action="./index.php?btn_edit" method="post">
                                                ...
                                                <input name="" type="submit" value="Trả lời" class="text-xs edit">
...
<script>
    ...
    $('.question').addClass('bg-gradient-primary')
</script>
<!-- Github buttons -->
