            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-primary shadow-primary border-radius-lg pt-4 pb-3">
                        <h6 class="text-white text-capitalize ps-3">Cập nhật mã khuyến mãi</h6>
                    </div>
                    <div class="pst-ab">
                        ...
                        <form action="./index.php?btn_update" enctype="multipart/form-data" method="post" style="display:flex;width:95%;margin:auto">
                            <div class="row pb-4">
                                <div class="col-4">
                                    ...
                                    <input class=" flex-auto focus:outline-none" type="text" name="name" value="<?=$discount['name']?>">
                            ...
                            <div class="row pb-4">
                                ...
                                <div class="col-4">
                                    ...
                                    <input  class=" date_start flex-auto focus:outline-none" type="date" name="date_start"  value="<?=$discount['date_start']?>">
                                ...
                                <div class="col-4">
                                    ...
                                    <input class="date_end flex-auto focus:outline-none" type="date" name="date_end"  value="<?=$discount['date_end']?>">
                                ...
                                <div class="col-4">
                                    ...
                                    <input class=" percent	flex-auto focus:outline-none" type="number" name="percent" value="<?=$discount['percent']?>">
                                    <p class="chkPercent text-danger"></p>
                                    <?php
                                    if (!empty($percent_err)) echo $birtday_err;
                                    ?>
